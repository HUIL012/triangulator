function initInterface() {
    ...
    svgSaver.onclick = function() {
        ...
        document.getElementById('svgFile').innerHTML = ": 保存 <a href-lang='image/svg+xml' href='data:image/svg+xml;base64,\n" + b64 + "' title='artwork.svg'>此链接</a> 为文件";
